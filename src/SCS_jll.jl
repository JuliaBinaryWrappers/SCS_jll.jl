...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import SCS_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("f4f2fc5b-1d94-523c-97ea-2ab488bedf4b"))
platforms = [Pkg.Artifacts.unpack_platform(e, "SCS", artifacts_toml) for e in artifacts["SCS"]]
...
if best_platform === nothing
    @debug("Unable to load SCS; unsupported platform $(triplet(platform_key_abi()))")
else
